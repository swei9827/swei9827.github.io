...
{	
	...
	glBegin(GL_QUADS);
		glTexCoord2d (0.0, 0.0);	glVertex3f (position.mVal [0] - displacementX, position.mVal [1] - displacementY, 0);
		glTexCoord2d (1.0, 0.0);	glVertex3f (position.mVal [0] + displacementY, position.mVal [1] - displacementX, 0);
		glTexCoord2d (1.0, 1.0);	glVertex3f (position.mVal [0] + displacementX, position.mVal [1] + displacementY, 0);
		glTexCoord2d (0.0, 1.0);	glVertex3f (position.mVal [0] - displacementY, position.mVal [1] + displacementX, 0);
	glEnd();
