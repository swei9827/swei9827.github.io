...
public:
	...
	void sendMyData(float xpos, float ypos, float xvel, float yvel, float xaccel, float yaccel, float rotation);
	void sendMyBullet(Vector startPos, Vector vel, float rotation, bool bouncing);
